...
<body>
	<nav class="navbar navbar-default">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      <a class="navbar-brand" href="index.html">Spring Boot</a>
	    </div>
	...
	<div class="container">
		<div class="w3-row-padding">
			<div class="w3-third">
				<h3>Spring Boot <font color="blue">COMPONENTS</font></h3>
			...
			<div class="w3-third">
				<h3>Angular <font color="blue">Consuming</font> the REST Service</h3>

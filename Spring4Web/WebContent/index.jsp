...
<body>
	<div class="container">
		...
		<div class="w3-row-padding">
			...
			<div class="w3-third">
				<h2>Hiberate</h2>
					<li><a href="/Spring4Web/hibernate/CreatePerson.jsp" target="_blank">Create->1 row in Table</a></li>
					<li><a href="/Spring4Web/hibernate/UserSingleAddressInsertTest.jsp" target="_blank">Create->1 Address for an User</a></li>
					<li><a href="/Spring4Web/hibernate/StudentMultipleAddressInsert.jsp" target="_blank">Create->Multiple Address for a Student</a></li>
					<li><a href="/Spring4Web/hibernate/hql.jsp" target="_blank">HQL</a></li>					
